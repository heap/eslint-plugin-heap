...
const RULE_NAME = 'no-test-file-imports';
...
const isDockerIgnored = (absoluteBaseUrl, relativePath) => {
    const relativePathWithExtension = getExtension(absoluteBaseUrl, relativePath);
...
exports.default = (0, createRule_1.createRule)({
    ...
    meta: {
        ...
        schema: [],
        messages: {
            noTestFileImports: 'You are importing a file ingored by `.dockerignore`, which will cause deploys to fail. Either remove the import or rename the current file you are working in to match a pattern defined in `.dockerignore`',
        },
    },
    defaultOptions: [],
    create: (context) => {
